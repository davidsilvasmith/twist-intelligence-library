...
founder_images = {
  "Andrew D'Souza": "https://images.openai.com/blob-placeholder/andrew-dsouza.jpg",
  "Victor Riparbelli": "https://images.openai.com/blob-placeholder/victor-riparbelli.jpg",
  "Ryan Carson": "https://images.openai.com/blob-placeholder/ryan-carson.jpg",
  "Rob May": "https://images.openai.com/blob-placeholder/rob-may.jpg"
}
...
for founder in data['trajectory_delta']:
    ...
    (root/'founders'/f'{slug(name)}.html').write_text(base_page(name, body))
